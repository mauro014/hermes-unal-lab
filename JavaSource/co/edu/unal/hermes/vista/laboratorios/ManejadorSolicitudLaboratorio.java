 ...
 * 
 */
public class ManejadorSolicitudLaboratorio extends ManejadorBase {
	...
	public ManejadorSolicitudLaboratorio() {

		System.out.println("ManejadorSolicitudLaboratorio");
		...
		esLaboratoriosFacultad = (Boolean) sesion
				.getAttribute("esLaboratoriosFacultad");
		...
		System.out.println("ManejadorSolicitudLaboratorio personaActual:"
				+ personaActual);

		cargarListaSolicitudes();

		selectItemTipoSolicitud = servicioGeneral
				.selectItemHijosDeTiposValorObjeto(Tipos.TIPOS_SOLICITUDES_LABORATORIO);
		...
		listaLabs = servicioGeneral.obtenerObjetosLimitado(Laboratorio.class,
				hqlBuscarLabs);
		...
		for (Laboratorio l : listaLabs) {
			selectItemLaboratorios[i] = new SelectItem(l.getId(), l.getSede()
					.getNombre() + " (" + l.getId() + ") " + l.getNombre());
			i++;
	...
	public void cargarListaSolicitudes() {
		...
		listaSolicitudes = servicioGeneral.obtenerObjetos(
				SolicitudLaboratorios.class, hqlBuscarSols);
	...
	public String crearSolicitud() {
		...
		nuevaSolicitud.getTipoSolicitud().setId(
				Tipos.TIPO_SOLICITUD_LABORATORIO_CREACION);
		soloLectura = false;
		return "consultarEditarSolicitudLaboratorio";
	}
