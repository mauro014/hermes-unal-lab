...
public class ManejadorConsultaHistoricos extends ManejadorBase {
    
    public static final String MANEJADOR_CONSULTA_HISTORICOS_SESSION = "manejadorConsultaHistoricos";
	...
	private boolean primerBusquedaHistoricoEstadosLegalizacion;
	private boolean primerBusquedaHistoricoInforme;
	List<HistoricoEstadoProyecto> listaHistoricoEstadoProyecto;
	List<HistoricoEstadoLegalizacion> listaHistoricoEstadoLegalizacion;
	...
	public ManejadorConsultaHistoricos() {
		super();
		codigoSesion = false;
		...
		primerBusquedaHistoricoEstadosLegalizacion = true;
		cargarDatosSesion();
		try{
	...
	public void cargarDatosSesion() {
		...
		// Se valida si se desea buscar historico estado legalizacion
		if (sesion.getAttribute("buscarHistoricoEstadosLegalizacion") != null) {
			sesion.removeAttribute("buscarHistoricoEstadosLegalizacion");
			buscarEstadosLegalizacion();
		}
	...
	public void buscarEstadosLegalizacion() {
		primerBusquedaHistoricoEstadosLegalizacion = false;
		Long id = validarCodigo();
		if (error.equals("")) {
			Proyecto proyecto = new Proyecto();
			proyecto.setId(id);
			listaHistoricoEstadoLegalizacion = servicioProyecto
					.obtenerHistoricosEstadosLegalizacion(id);
		}
	}
	...
	public boolean isPrimerBusquedaHistoricoEstadosLegalizacion() {
		return primerBusquedaHistoricoEstadosLegalizacion;
	}

	public List<HistoricoEstadoLegalizacion> getListaHistoricoEstadoLegalizacion() {
		return listaHistoricoEstadoLegalizacion;			
	}	
