...
public class ManejadorProblemasAprobados extends ManejadorBase {
	...
	private boolean panelPreinscritos = false;

	public ManejadorProblemasAprobados() {
		//idCurso = "34589";
		//idCurso = "39232";//proyecto 2017
		idCurso = "42585";//proyecto 2018
		//cursoActual = (Proyecto) sesion.getAttribute("cursoECP");
		
		panelPreinscritos = true;
		cargarCursoActual();
		cargarListaPreinscritosOriginal();
	...
	public boolean isPanelPreinscritos() {
		return panelPreinscritos;
	}

	public void setPanelPreinscritos(boolean panelPreinscritos) {
		this.panelPreinscritos = panelPreinscritos;
	}
