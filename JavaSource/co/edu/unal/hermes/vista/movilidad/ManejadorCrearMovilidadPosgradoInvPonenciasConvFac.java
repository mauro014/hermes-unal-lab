...
public class ManejadorCrearMovilidadPosgradoInvPonenciasConvFac extends ManejadorBaseMovilidad {

    private static final long serialVersionUID = -6924171724694523416L;
    ...
    public ManejadorCrearMovilidadPosgradoInvPonenciasConvFac() {
        ...
        if(idMovilidadEd != null){
        	...
        	costoInscripcion = mep.getCostoevento();
        	fechaInicioEvento = mep.getFechainicial();
        	fechaFinEvento = mep.getFechafinal();
        	aceptacionFacultad = mep.getAceptacion();
        	valorViaticos = mep.getValorViaticos();
        	universidad = mep.getUniversidad();   	
        	submodalidad = mep.getSubModalidadConvocatoria();
        	valorTotalMovSolicitado = mep.getValorTotalMovilidadSolicitado();
        ...
        if (sesion.getAttribute("idConvocatoriaActual") != null) {
            ...
            if (listConvocatorias.size() > 0 && listConvocatorias != null) {
                    ...
                    if (convActual.getEsParaGrupos()) {
        				...
        				listaOpcionsSeleDos = servicioGeneral
        			   			 .obtenerObjetos("select dd from Dominio d, DominioDetalle dd where d.id = dd.identificador.id and d.tipo ='"
        			   					 + convActual.getRequisitosConvTexto() + "' order by dd.descripcion");
                ...
                if(tipoPonenciaPar != null){
                	...
                	listaTipoPonencia = servicioGeneral.obtenerListaObjetos("TipoPonencia where (mostrar = 'P' and id in (12, 13)) or id in (2)");
                }
        ...
        if (nExiste < 0) {
            ...
            if (estudiante != null) {
                ...
                if (estudiante.getPlan().getTipo().equals(5L) || estudiante.getPlan().getTipo().equals(6L) ||estudiante.getPlan().getTipo().equals(7L)) {
                	caracterEventoItem =  new SelectItem[3];
                	...
                	caracterEventoItem[2] = new SelectItem("3", "Nacional");
                }else{
                ...
                if(restriccionArchivosConv != null){
                	if(restriccionArchivosConv.equals("CF_723") || restriccionArchivosConv.equals("CF_738")){
                		caracterEventoItem =  new SelectItem[3];
                    	caracterEventoItem[0] = new SelectItem("1", "Internacional en Colombia");
                    	caracterEventoItem[1] = new SelectItem("2", "Internacional en el extranjero");
                    	caracterEventoItem[2] = new SelectItem("5", "Nacional en el extranjero");	
                	}else{
                		if(restriccionArchivosConv.equals("CF_724") || restriccionArchivosConv.equals("CF_739")){
                			caracterEventoItem =  new SelectItem[4];
                        	caracterEventoItem[0] = new SelectItem("1", "Internacional en Colombia");
                        	caracterEventoItem[1] = new SelectItem("2", "Internacional en el extranjero");
                        	caracterEventoItem[2] = new SelectItem("4", "Nacional en Colombia");
                        	caracterEventoItem[3] = new SelectItem("5", "Nacional en el extranjero");
                		}else{
                			if(restriccionArchivosConv.equals("CF_727")){
                    			caracterEventoItem =  new SelectItem[4];
                    			caracterEventoItem[0] = new SelectItem("1", "Internacional en Colombia");
                            	caracterEventoItem[1] = new SelectItem("2", "Internacional en el extranjero");
                            	caracterEventoItem[2] = new SelectItem("3", "Nacional");
                    		}else{
                    			if(restriccionArchivosConv.equals("CF_745")){
                        			caracterEventoItem =  new SelectItem[2];
                                	caracterEventoItem[0] = new SelectItem("1", "Internacional en Colombia");
                                	caracterEventoItem[1] = new SelectItem("5", "Nacional en el extranjero");
                        		}
                    		}
                		}
                	}
    ...
    public void guardar() {
        ...
        mep.setEvento(cortarCadena(nombreEvento, 2000));
        mep.setTitulo(cortarCadena(tituloPonencia, 2000));
        mep.setCiudad(cortarCadena(ciudadEvento, 255));
        mep.setCostotiquete(costoTiquetes);
        mep.setResumen(cortarCadena(resumenPonencia, 3900));
        mep.setInscripcionevento(solInscripcion);
        mep.setOtroTipoPonencia(cortarCadena(otroTipoPonencia, 100));
        mep.setCostoevento(costoInscripcion);
        mep.setFechainicial(fechaInicioEvento);
        mep.setFechafinal(fechaFinEvento);
        mep.setAceptacion(aceptacionFacultad);
        mep.setValorViaticos(valorViaticos);
        mep.setUniversidad(cortarCadena(universidad, 1000));
        mep.setCaracterEvento(caracterEvento != null ? caracterEvento : "");
        ...
        mep.setSubModalidadConvocatoria(submodalidad);
        mep.setValorTotalMovilidadSolicitado(valorTotalMovSolicitado);
        ...
        listaTipoMovilidad = servicioGeneral.obtenerListaObjetos("TipoMovilidad where id ='CF_MOV6'");
        ...
        if (validar(mep)) {
            ...
            noExiste = "Solicitud de movilidad guardada correctamente, con el número " + mep.getId()
           ...
           /* noExiste = "La movilidad con código" + mep.getId() + "se ha guardado y enviado correctamente al usuario a través del "
    ...
    public void guardarConvocatoriaFacultad() {
        ...
        if (validar(mep)) {
            ...
            noExiste1 = "Solicitud de movilidad guardada correctamente, con el número " + mep.getId()
                    + ".  Se ha enviado a su correo electrónico un mensaje confirmando el registro.";
    ...
    private boolean validar(MovilidadEstudiantesPosgrado mov) {
         ...
         * 
         * String error = "Se debe seleccionar un proyecto. \n"; bErrorProyecto
         * = true; errores[0] = error; result = false;
         * 
         * }
         */
        ...
        if(tipoConvocatoria.equals("CF_MOV6") && restriccionTiquetes != null){  
        ...
        if (mep.getPapaEstudiante() < 0.0) {
            String error = "El Promedio aritmético es inferior a  4.0  \n";
            errores[10] = error;
            bErrorPapa = true;
            result = false;
        }
    ...
    public void guardarArchivoObligatorio(FileUploadEvent event) {
        try {
            ...
            if (archivoObligatorio.getContents() != null) {
                ...
                nombreObligatorio = archivoObligatorio.getFileName().substring(i + 1);
                ...
                archivoMovilidad.setNombre(archivoObligatorio.getFileName().substring(i + 1));
                archivoMovilidad.setFecha(new Date());
                archivoMovilidad.setTipoMovilidad(tipoMovilidad);
                ...
                listaTipoArchivo = servicioGeneral
                        .obtenerListaObjetos("TipoArchivoMovilidad where id ='" + tipoDocumentoSel + "'");
                ...
                listaMovilidadArchivo = servicioGeneral.obtenerListaArchivosMovilidad(restriccionArchivosConv,
                        new Long(tipoDocumentoSel));

                // MovilidadArchivo mva1 = (MovilidadArchivo)
                // listaMovilidadArchivo
                // .get(0);

                // tipoDocumentoSelItem = new SelectItem[0];
                // listaArchivosObligatorios= new ArrayList();
                // listaArchivosObligatorios = servicioGeneral
                // .obtenerListaArchivosMovilidad("A1");

                // MovilidadArchivo mva2 = new MovilidadArchivo();
                // mva2 = (MovilidadArchivo) tablaArchivosObligatoriosSel
                // .getRowData();
    ...
    public void eliminarArchivoObligatorio() {
        ...
        /*
         * List listaTipoArchivo; listaTipoArchivo = new ArrayList();
         * listaTipoArchivo = servicioGeneral .obtenerListaObjetos(
         * "TipoArchivoMovilidad where id ='" + amv.getTipoArchivo().getId() +
         * "'"); TipoArchivoMovilidad tipoArchivo = (TipoArchivoMovilidad)
         * listaTipoArchivo .get(0);
         * 
         * List listaMovilidadArchivo; listaMovilidadArchivo = new ArrayList();
         * listaMovilidadArchivo =
         * servicioGeneral.obtenerListaArchivosMovilidad( "D1",
         * amv.getTipoArchivo().getId());
         * 
         * MovilidadArchivo mva1 = (MovilidadArchivo)
         * listaMovilidadArchivo.get(0);
         */
    }
	...
	/**
	 * @param caracterEventoItem the caracterEventoItem to set
	 */
	...
	/**
	 * @param esModConcurso the esModConcurso to set
	 */
