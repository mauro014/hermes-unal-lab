...
public class ManejadorConsultarMovilidadEstArt extends ManejadorBase {
	...
	public ManejadorConsultarMovilidadEstArt() {
					...
					if (this.personaActual instanceof InvestigadorInterno) {
						...
						if (investigadorInterno.getTipoDedicacion() != null
							...
							if (est != null && est.size() > 0) {
								...
								this.documentoDocente = estudianteActual.getId()
										.getDocumento();
	...
	private void cargarValoresIniciales() {
		...
		areaArte.add(new SelectItem("Performance/ Teatro /Artes Vivas", "Performance/ Teatro /Artes Vivas"));
		areaArte.add(new SelectItem("Sonido", "Sonido"));
		areaArte.add(new SelectItem("Historia/Teoría del arte/Curaduría", "Historia/Teoría del arte/Curaduría"));
...
public String imprimirReporte() {
		...
		r.setNombreReporte("/movilidad/ReporteMovilidadEstArt");
