...
public class ManejadorConsultarMovilidadDocArt extends ManejadorBase {
	...
	public ManejadorConsultarMovilidadDocArt() {
			...
			if (estado >= 9) {
				...
				if (movArt.getConfirmarResidencia().equals("SI")) {
					...
					if (movArt.getConfirmarResidencia().equals("NO")) {
						...
						//this.limpiar();
						ocultarPaneles(0);
						//this.errores[0] = "Para confirmar la solicitud de la residencia, por favor ingrese por el menú\n Investigador, Movilidades\n, Actualizar Residencia de Artes.";
						//this.panelRenderError[0] = true;
