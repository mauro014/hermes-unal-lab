...
public class ManejadorEditarSedeMovilidadEstArt extends ManejadorBase {
	...
	public ManejadorEditarSedeMovilidadEstArt() {
	...
	public void avalAprobar(){
		...
		if(this.avalDescripcion == null || this.avalDescripcion.length() <= 0){
			...
			if (objeto != null && objeto.size() > 0) {
				...
				try {
					String sql = "update HER_MOVILIDAD_ESTUDIANTES_ART set MOV_AVAL_SEDE = 'SI', MOV_DESCRIPCION_SEDE = '"+this.avalDescripcion+"'  where MOV_ID = '"+ movilidad.getId()+"'";
    ...
    public void avalNegar(){
    	...
    	if(this.avalDescripcion == null || this.avalDescripcion.length() <= 0){
			...
			if (objeto != null && objeto.size() > 0) {
				...
				try {
					String sql = "update HER_MOVILIDAD_ESTUDIANTES_ART set MOV_AVAL_SEDE = 'NO', MOV_DESCRIPCION_SEDE = '"+this.avalDescripcion+"'  where MOV_ID = '"+ movilidad.getId()+"'";
					servicioGeneral.eliminar(sql);
				} catch (SQLException e) {
					System.out.println(e.toString());
				} 
