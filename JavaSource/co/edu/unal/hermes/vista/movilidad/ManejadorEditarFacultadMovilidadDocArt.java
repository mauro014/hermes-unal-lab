...
public class ManejadorEditarFacultadMovilidadDocArt extends ManejadorBase {
	...
	public ManejadorEditarFacultadMovilidadDocArt() {
	...
	public void avalAprobar(){
		...
		if(this.avalDescripcion == null || this.avalDescripcion.length() <= 0){
			...
			if (objeto != null && objeto.size() > 0) {
				...
				try {
					String sql = "update HER_MOVILIDAD_DOCENTES_ART set MOV_AVAL_FACULTAD = 'SI', MOV_DESCRIPCION_FACULTAD = '"+this.avalDescripcion+"'  where MOV_ID = '"+ movilidad.getId()+"'";
				...
				sesion.removeAttribute("ManejadorEditarSedeMovilidadDocArt");
    ...
    public void avalNegar(){
    	...
    	if(this.avalDescripcion == null || this.avalDescripcion.length() <= 0){
			...
			if (objeto != null && objeto.size() > 0) {
				...
				movilidad.setDescripcionFacultad(this.avalDescripcion);
				try {
					String sql = "update HER_MOVILIDAD_DOCENTES_ART set MOV_AVAL_FACULTAD = 'NO', MOV_DESCRIPCION_FACULTAD = '"+this.avalDescripcion+"'  where MOV_ID = '"+ movilidad.getId()+"'";
					servicioGeneral.eliminar(sql);
				} catch (SQLException e) {
					System.out.println(e.toString());
				} 
