...
public class ManejadorPreinscripcionBancoProblemas extends ManejadorBase {
    ...
    protected List<SelectItem> rolRegistroItemList;
    protected List<SelectItem> temaProblemaItemList;
    protected List<SelectItem> subTemaProblemaItemList;
    ...
    protected List<SelectItem> ciudadItemListProblema;
    ...
    private Departamento departamento_atributo_problema;
    private Ciudad ciudad_atributo_problema;
    ...
    private static Logger logger = Logger.getLogger(ManejadorPreinscripcionBancoProblemas.class.getName());
    int numeroTab;
    ...
    private String departamentoProblema;
    private String ciudadProblema;

    private String departamentoP;
    private String ciudadP;
    private String rolRegistro;
    private String modalidadRegistro;
    private String otroTipoMedioInfo;

    public ManejadorPreinscripcionBancoProblemas() {
        ...
        // id_oferta = 34589;
        //id_oferta = 39232;// proyecto 2017
        id_oferta = 42585;//proyecto 2018

        String cons_oferta = "select pp from Proyecto pp where pp.id = " + id_oferta;
    ...
    public void cargarValoresIniciales() {
        ...
        descripcionProblema = "";
        ubicacionProblema = "";
        comunidadObjetivoProblema = "";

        departamento_atributo_problema = null;
        departamentoProblema = "CO11";
        ciudad_atributo_problema = null;
     ...
     * @return the string
     */
    public String verProblemasAprobados() {
        sesion.removeAttribute("ManejadorProblemasAprobados");
        return "irInformacionProblemas";
    }
    ...
    public void validarTipoVinculacion() {
        ...
        if (esEstudiante || esEmpleado || esDocente || esContratista || esEgresado)
            esExterno = false;
        else
            esExterno = true;
    ...
    public void buscarPreinscripcion() {
        ...
        if (curso.getEstadoProyecto().getId().equals("PB")) {
            ...
            if (!documento.equals("")) {
                ...
                String cons_preins = "Select pp from Preinscripcion_ECP pp where pp.investigador.id.documento = '"
                        + this.documento + "' " + "and pp.investigador.id.tipoDocumento = '" + this.tipo_doc + "' "
                        + "and pp.curso.id = " + id_oferta;
                ...
                if (lista_preins.size() < 0) // LA PREINSCRIPCION YA EXISTE
                                             // [ACTUALIZAR]
                {
                    preins_ecp_objeto = (Preinscripcion_ECP) lista_preins.get(0);

                    List listaArchivosExistentes = servicioGeneral.obtenerObjetos(
                            "select e from ArchivosPreinscripcionECP e where e.preinscripcionECP.id_pre = "
                                    + preins_ecp_objeto.getId_pre());
                    if (listaArchivosExistentes.size() > 0 && listaArchivosExistentes != null) {
                        for (int i = 0; i < listaArchivosExistentes.size(); i++) {
                            ArchivosPreinscripcionECP ar = (ArchivosPreinscripcionECP) listaArchivosExistentes.get(i);
                            ar.setEsNuevo(false);
                    ...
                    if (preins_ecp_objeto.getDepartamento() != null) {
                        ...
                        setDepartamento_atributo(preins_ecp_objeto.getDepartamento());
                        setDepartamentoProblema(preins_ecp_objeto.getDepartamentoProblema().getId());
                    ...
                    if (preins_ecp_objeto.getCiudadProblema() != null) {
                        setCiudad_atributo_problema(preins_ecp_objeto.getCiudadProblema());
                        setCiudadProblema(preins_ecp_objeto.getCiudadProblema().getId());
                    } else {
                        setCiudad_atributo_problema(null);
                        setCiudadProblema(null);
                    }

                    if (preins_ecp_objeto.getDepartamentoProblema() != null) {
                        setDepartamento_atributo_problema(preins_ecp_objeto.getDepartamentoProblema());
                        setDepartamentoProblema(preins_ecp_objeto.getDepartamentoProblema().getId());
                    } else {
                        setDepartamento_atributo_problema(null);
                        setDepartamentoProblema(null);
                    }

                    setFormacion_academica_atributo(preins_ecp_objeto.getFormacion_academica());
                    setFormacion_academica(preins_ecp_objeto.getFormacion_academica().getId());
                    ...
                    setOtroTipoMedioInfo(preins_ecp_objeto.getOtroMedioPublicidad());
                    setSector_empresa(preins_ecp_objeto.getSector_empresa());
                    setTipo_empresa(preins_ecp_objeto.getTipo_empresa());

                    setDireccion_empresa(preins_ecp_objeto.getDireccion_empresa());
                    ...
                    if (preins_ecp_objeto.getOtros_intereses() != null) {
                        setOtros_intereses_atributo(preins_ecp_objeto.getOtros_intereses());
                        setOtros_intereses(preins_ecp_objeto.getOtros_intereses().getId());
                    } else {
                    ...
                    setApellidosRepLegal(preins_ecp_objeto.getApellidosRepLegal());

                    setNombreProblema(preins_ecp_objeto.getNombreProblema());
                    setDescripcionProblema(preins_ecp_objeto.getDescripcionProblema());
                    setUbicacionProblema(preins_ecp_objeto.getUbicacionProblema());
                    setComunidadObjetivoProblema(preins_ecp_objeto.getComunidadObjetivoProblema());

                    ins_act = "A";
                    FacesContext.getCurrentInstance().addMessage("growl", new FacesMessage(FacesMessage.SEVERITY_INFO,
                            "Registro existente", "Por favor actualice sus datos"));
                    ...
                    FacesContext.getCurrentInstance().addMessage("growl",
                            new FacesMessage(FacesMessage.SEVERITY_INFO, "Nuevo Registro",
            ...
            FacesContext.getCurrentInstance().addMessage("growl",
                    new FacesMessage(FacesMessage.SEVERITY_ERROR, "El curso no tiene una oferta vigente", ""));

        if (ins_act.equals("I"))
            aceptaTerminos = false;
        else if (ins_act.equals("A"))
            aceptaTerminos = true;
        else
            aceptaTerminos = false;
    ...
    public boolean esPersona() {
        String cons_persona;
        if (!documento.equals("")) {
            cons_persona = "Select pp from Persona pp where pp.id.documento like '" + this.documento
                    + "' and pp.id.tipoDocumento like '" + this.tipo_doc + "'";
            List lista_persona = servicioGeneral.obtenerObjetos(cons_persona);
            if (lista_persona.size() != 0) {
                persona = (Persona) lista_persona.get(0);
                System.out.println(
                        "   -> ES PERSONA  <-  " + persona.getId().getDocumento() + " - " + persona.getNombre1() + " "
    ...
    public boolean esEstudiante() {
        ...
        if (!documento.equals("")) {
            cons_estudiante = "Select pp from Estudiante pp where pp.id.documento like '" + this.documento
                    + "' and pp.id.tipoDocumento like '" + this.tipo_doc + "'" + "and pp.interno in ('S')"; // Estudiantes
                                                                                                            // activos

            List lista_estudiante = servicioGeneral.obtenerObjetos(cons_estudiante);
            if (lista_estudiante.size() != 0) {
                estudiante = (Estudiante) lista_estudiante.get(0);
                System.out.println("   -> ES ESTUDIANTE  <-  " + estudiante.getId().getDocumento());
                return true;
            } else
                return false;
        } else
    ...
    public boolean esDocente() {
        String cons_docente;
        if (!documento.equals("")) {
            cons_docente = "Select pp from Investigador pp where pp.id.documento like '" + this.documento + "'"
                    + "and pp.id.tipoDocumento like '" + this.tipo_doc + "' " + "and pp.interno in ('S') " + // Docente
                                                                                                             // activo
            ...
            if (lista_docente.size() != 0) {
                ...
                System.out.println("   -> ES DOCENTE  <-  " + docente.getId().getDocumento());
                return true;
            } else
                return false;
        } else {
    ...
    public boolean esEmpleado() {
        ...
        if (!documento.equals("")) {
            cons_empleado = "Select pp from Investigador pp where pp.id.documento like '" + this.documento + "'"
                    + "and pp.id.tipoDocumento like " + "'" + this.tipo_doc + "'" + "and pp.esFuncionario in ('S') ";

            List lista_empleado = servicioGeneral.obtenerObjetos(cons_empleado);

            if (lista_empleado.size() != 0) {
                empleado = (Investigador) lista_empleado.get(0);
                System.out.println("   -> ES EMPLEADO  <-  " + empleado.getId().getDocumento());
                return true;
            } else
                return false;
        } else {
    ...
    public void datosPersona() {
        if (persona != null) {
            ...
            if (persona.getCiudadDomicilio() != null) {
                setCiudad(persona.getCiudadDomicilio().getId());
            }
            setFecNacimiento(persona.getFechaNacimiento());
            setTel_movil(persona.getCelular());
    ...
    public void datosEstudiante() {
        if (estudiante != null) {
            ...
            if (estudiante.getCiudadDomicilio() != null) {
                setCiudad(estudiante.getCiudadDomicilio().getId());
            }
    ...
    public void datosDocente() {
        if (docente != null) {
            ...
            if (docente.getCiudadDomicilio() != null) {
                setCiudad(docente.getCiudadDomicilio().getId());
            }
            setFecNacimiento(docente.getFechaNacimiento());
            setTel_movil(docente.getCelular());
    ...
    public void datosEmpleado() {
        ...
        if (empleado != null) {
            ...
            setPrimer_nombre(empleado.getNombre1());
            setSegundo_nombre(empleado.getNombre2());
            setPrimer_apellido(empleado.getApellido1());
            setSegundo_apellido(empleado.getApellido2());
            setCorreo_electronico(empleado.getEmail());
            if (empleado.getCiudadDomicilio() != null) {
                setCiudad(empleado.getCiudadDomicilio().getId());
            }
            setTel_fijo(empleado.getTelefono());
            setTel_movil(empleado.getCelular());
            setDireccion(empleado.getDireccion());
        }
    }

    public void construir_objetosOriginal() {
        String cons_pais, cons_depto, cons_ciud, cons_formacion, cons_tddoc, cons_otros_intereses, cons_tpvinculacion,
                cons_oferta, cons_estado_civil, cons_ocupacion, cons_sector, cons_naturaleza, cons_medio;
        ...
        cons_tddoc = "select pp from TipoDocumento pp where  pp.id like '%" + this.tipo_doc + "%'";
        ...
        if (pais.equals("CO")) {
            cons_depto = "select dd from Departamento dd where  dd.id  like '%" + this.departamento + "%'";
            List lista_depto = servicioGeneral.obtenerObjetos(cons_depto);
            departamento_atributo = (Departamento) lista_depto.get(0);

            cons_ciud = "select cc from Ciudad cc where  cc.id like '%" + this.ciudad + "%'";
            List lista_ciud = servicioGeneral.obtenerObjetos(cons_ciud);
            ciudad_atributo = (Ciudad) lista_ciud.get(0);
        }

        cons_formacion = "select pp from TipoFormacion pp where  pp.id like '%" + this.formacion_academica + "%'";
        ...
        if (!otros_intereses.equals("")) {
            if (!otros_intereses.equals("N")) {
                cons_otros_intereses = "select pp from AgendaConocimiento pp where  pp.id like " + this.otros_intereses;
                List lista_otrosIntereses = servicioGeneral.obtenerObjetos(cons_otros_intereses);
                otros_intereses_atributo = (AgendaConocimiento) lista_otrosIntereses.get(0);
            } else
                otros_intereses_atributo = null;
        }
        cons_ocupacion = "select pp from DominioDetalle pp where  pp.identificador.tipo like '%" + this.ocupacion
                + "%'";
        ...
        cons_sector = "select pp from DominioDetalle pp where  pp.identificador.tipo like '%" + this.sector_empresa
                + "%'";
        List lista_sector = servicioGeneral.obtenerObjetos(cons_sector);
        sector_atributo = (DominioDetalle) lista_sector.get(0);

        cons_naturaleza = "select pp from DominioDetalle pp where  pp.identificador.tipo like '%" + this.tipo_empresa
                + "%'";
        ...
        if (!medio_publicidad.equals("")) {
            cons_medio = "select pp from DominioDetalle pp where  pp.identificador.tipo like '%" + this.medio_publicidad
                    + "%'";
        ...
        List lista_tpVinculacion = servicioGeneral.obtenerObjetos(cons_tpvinculacion);
    ...
    public void construir_objetos() {
        String cons_pais, cons_depto, cons_ciud, cons_formacion, cons_tddoc, cons_otros_intereses, cons_tpvinculacion,
                cons_oferta, cons_ocupacion, cons_medio;
        ...
        cons_tddoc = "select pp from TipoDocumento pp where  pp.id = '" + this.tipo_doc + "'";
        List lista_tpdoc = servicioGeneral.obtenerObjetos(cons_tddoc);
        tipo_documento = (TipoDocumento) lista_tpdoc.get(0);
        ...
        cons_pais = "select pp from Pais pp where  pp.id = '" + this.pais + "'";
        List lista_pais = servicioGeneral.obtenerObjetos(cons_pais);
        pais_atributo = (Pais) lista_pais.get(0);

        if (pais.equals("CO")) {
            cons_depto = "select dd from Departamento dd where  dd.id  = '" + this.departamento + "'";
            List lista_depto = servicioGeneral.obtenerObjetos(cons_depto);
            departamento_atributo = (Departamento) lista_depto.get(0);

            cons_ciud = "select cc from Ciudad cc where  cc.id = '" + this.ciudad + "'";
            List lista_ciud = servicioGeneral.obtenerObjetos(cons_ciud);
            ciudad_atributo = (Ciudad) lista_ciud.get(0);
        }

        cons_depto = "select dd from Departamento dd where  dd.id  = '" + this.departamentoProblema + "'";
        List lista_depto = servicioGeneral.obtenerObjetos(cons_depto);
        departamento_atributo_problema = (Departamento) lista_depto.get(0);

        cons_ciud = "select cc from Ciudad cc where  cc.id = '" + this.ciudadProblema + "'";
        List lista_ciud = servicioGeneral.obtenerObjetos(cons_ciud);
        ciudad_atributo_problema = (Ciudad) lista_ciud.get(0);

        if (this.formacion_academica != null && !this.formacion_academica.equals("")) {
            cons_formacion = "select pp from TipoFormacion pp where  pp.id = '" + this.formacion_academica + "'";
            List lista_tpformacion = servicioGeneral.obtenerObjetos(cons_formacion);
            formacion_academica_atributo = (TipoFormacion) lista_tpformacion.get(0);
        } else {
            cons_formacion = "select pp from TipoFormacion pp where  pp.id = '" + "ME" + "'";
            List lista_tpformacion = servicioGeneral.obtenerObjetos(cons_formacion);
            formacion_academica_atributo = (TipoFormacion) lista_tpformacion.get(0);
        }
        ...
        if (!otros_intereses.equals("")) {
            if (!otros_intereses.equals("N")) {
                cons_otros_intereses = "select pp from AgendaConocimiento pp where  pp.id = " + this.otros_intereses;
                List lista_otrosIntereses = servicioGeneral.obtenerObjetos(cons_otros_intereses);
                otros_intereses_atributo = (AgendaConocimiento) lista_otrosIntereses.get(0);
            } else
                otros_intereses_atributo = null;
        ...
        //medio_publicidad = "1";
        if (!medio_publicidad.equals("")) {
            cons_medio = "select pp from DominioDetalle pp where  pp.identificador.tipo = '" + this.medio_publicidad
                    + "'";
            List lista_medio = servicioGeneral.obtenerObjetos(cons_medio);
            medio_publicidad_atributo = (DominioDetalle) lista_medio.get(0);
        } else {
            cons_medio = "select pp from DominioDetalle pp where  pp.identificador.tipo = '" + "1" + "'";
            List lista_medio = servicioGeneral.obtenerObjetos(cons_medio);
            medio_publicidad_atributo = (DominioDetalle) lista_medio.get(0);
        }
    ...
    private boolean guardarPersonaInvestigadorBasico() {
        ...
        try {
            ...
            String cons_persona_invest = "select pp from Persona pp where pp.id.documento like '" + documento
                    + "' and pp.id.tipoDocumento like '" + tipo_doc + "'";
            List lista_persona = servicioGeneral.obtenerObjetos(cons_persona_invest);
            if (lista_persona.size() > 0) {
                ...
                Persona personaAux = servicioPersona.obtenerPersonaRoles(persona.getId());
                persona.setCiudadDomicilio(ciudad_atributo);

                inv = (Investigador) servicioGeneral.obtenerObjeto(new Investigador(), persona.getId());
                ...
                if (personaAux == null) {
                    ...
                    if (esEstudiante) {
                        ...
                        if (estudiante != null) {
                            Persona per = servicioPersona.obtenerPersona(estudiante.getId());
                            if (per == null) {

                                if (servicioPersona.insertarNuevaPersonaDatosBasicos(persona))// 2
                                {
                                    servicioPersona.agregarRolPersona(persona.getId(), rol);
                        ...
                        if (esEmpleado) {
                            ...
                            Persona per = servicioPersona.obtenerPersona(empleado.getId());

                            if (per == null) {

                                if (servicioPersona.insertarNuevaPersonaDatosBasicos(persona))// 3
                                {
                                    servicioPersona.agregarRolPersona(persona.getId(), rol);
                                    preins_ecp_objeto.setInvestigador(persona);
                                } else
                            ...
                            if (esPersona) {
                                ...
                                InvestigadorInterno iiAux = (InvestigadorInterno) servicioGeneral
                                        .obtenerObjeto(new InvestigadorInterno(), persona.getId());
                                CategoriaInvestigador ci = (CategoriaInvestigador) servicioGeneral
                                        .obtenerObjeto(new CategoriaInvestigador(), new Long(categoriaInvestigador));
                                if (iiAux != null) {
                                ...
                                Institucion i = (Institucion) servicioGeneral.obtenerObjeto(new Institucion(), "2843");
                                InvestigadorExterno ieAux = (InvestigadorExterno) servicioGeneral
                                        .obtenerObjeto(new InvestigadorExterno(), persona.getId());
                                CategoriaInvestigador ci = (CategoriaInvestigador) servicioGeneral
                                        .obtenerObjeto(new CategoriaInvestigador(), new Long(categoriaInvestigador));
                                if (ieAux != null) {
                                    ...
                                    if (ieAux.getContrasena() == null) {
                                        ieAux.setContrasena(new Long(servicioPersona.generarClaveExterno()));
                                    }
                                    servicioGeneral.guardarObjeto(ieAux);
                                } else {

                                    if (servicioPersona.insertarNuevaPersonaDatosBasicos(persona)) {
                                        InvestigadorExterno ie = new InvestigadorExterno();
                                        servicioPersona.convertivirPersonaAInvestigadorExterno(persona, ie);
                                        ...
                                        if (inv == null) {
                                            servicioPersona.insertarInvestigador(ie);
                                        }
                                        servicioPersona.insertarExternoContraseña(ie);
                                        servicioPersona.agregarRolPersona(persona.getId(), rol);
                                        preins_ecp_objeto.setInvestigador(ie);

                                        // servicioPersona.login(ie)
                                    } else
                                        errorInsertaPersona = true;
                                    //
                                }
                    ...
                    if (esEstudiante) {
                        ...
                        if (estudiante != null) {
                            ...
                            if (per == null) {
                                ...
                                if (servicioPersona.insertarNuevaPersonaDatosCompletos(persona))// 2
                                {
                                    servicioPersona.agregarRolPersona(persona.getId(), rol);
                                    preins_ecp_objeto.setInvestigador(persona);
                                } else
                        ...
                        if (esEmpleado) {
                            ...
                            if (per == null) {
                                ...
                                if (servicioPersona.insertarNuevaPersonaDatosCompletos(persona))// 3
                                {
                                    servicioPersona.agregarRolPersona(persona.getId(), rol);
                                    preins_ecp_objeto.setInvestigador(persona);
                                } else
        ...
        try {
            ...
            if (persona != null) {
                ...
                mensajeConfirmacion = "\nMATRICULA GUARDADA CON EXITO" + "\n\n"
                        ...
                        + "Nombres: " + preins_ecp_objeto.getInvestigador().getNombre1() + " "
                ...
                correo.adicionarDireccion(preins_ecp_objeto.getInvestigador().getEmail());

                //correo.adicionarCopiaOculta("sisii_nal@unal.edu.co");

                correo.setAsunto(
                        "Matricula CIENCIA PARA LAS REGIONES - Formulación de Proyectos Regionales en Ciencia, Tecnología e Innovación Realizada con Éxito");
    ...
    public void enviarCorreoECP() {
        try {
            ...
            if (persona != null) {
                ...
                CorreoPlantilla correoActual;

                List lista = servicioGeneral.obtenerListaObjetos(
                        "CorreoPlantilla co where co.nombre = 'Correo confirmación preinscripcion ECP'");
                correoActual = (CorreoPlantilla) lista.get(0);

                correoActual.setAsunto(correoActual.getAsunto().replaceAll("<<NOMBRE_CURSO>>", curso.getNombre()));

                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<NOMBRE_CURSO>>", curso.getNombre()));
                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<NOMBRE_ASISTENTE>>",
                        preins_ecp_objeto.getInvestigador().getNombre1() + " "
                                + preins_ecp_objeto.getInvestigador().getApellido1()));

                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<NOMBRE>>",
                        preins_ecp_objeto.getInvestigador().getNombre1() + " "
                                + preins_ecp_objeto.getInvestigador().getNombre2() + " "
                                + preins_ecp_objeto.getInvestigador().getApellido1() + " "
                                + preins_ecp_objeto.getInvestigador().getApellido2()));
                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<DOCUMENTO>>",
                        preins_ecp_objeto.getInvestigador().getId().getDocumento()));
                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<TIPO_DOCUMENTO>>",
                        preins_ecp_objeto.getInvestigador().getId().getTipoDocumento()));
                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<CORREO>>",
                        preins_ecp_objeto.getInvestigador().getEmail()));
                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<TELEFONO_FIJO>>",
                        preins_ecp_objeto.getInvestigador().getTelefono()));
                correoActual.setCuerpo(
                        correoActual.getCuerpo().replaceAll("<<TELEFONO_MOVIL>>", preins_ecp_objeto.getTel_movil()));
                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<DIRECCION>>",
                        preins_ecp_objeto.getInvestigador().getDireccion()));
                correoActual.setCuerpo(
                        correoActual.getCuerpo().replaceAll("<<CIUDAD>>", preins_ecp_objeto.getCiudad().getNombre()));

                if (preins_ecp_objeto.getInvestigador() instanceof InvestigadorExterno) {
                    InvestigadorExterno ie = (InvestigadorExterno) preins_ecp_objeto.getInvestigador();
                    correoActual.setCuerpo(
                            correoActual.getCuerpo().replaceAll("<<USUARIO_EXTERNOS>>", servicioPersona.login(ie)));
                    correoActual.setCuerpo(
                            correoActual.getCuerpo().replaceAll("<<CLAVE_EXTERNOS>>", ie.getContrasena().toString()));
                } else {
                    correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<USUARIO_EXTERNOS>>", "NO APLICA"));
                    correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<CLAVE_EXTERNOS>>", "NO APLICA"));
                }
    ...
    public void enviarCorreoBancoProblemas() {
        try {
            ...
            if (persona != null) {
                ...
                List lista = servicioGeneral.obtenerListaObjetos(
                        "CorreoPlantilla co where co.nombre = 'Correo confirmación - Registro banco de problemas'");
                correoActual = (CorreoPlantilla) lista.get(0);
                ...
                correoActual.setCuerpo(
                        correoActual.getCuerpo().replaceAll("<<CIUDAD>>", preins_ecp_objeto.getCiudad().getNombre()));
                correoActual
                        .setCuerpo(correoActual.getCuerpo().replaceAll("<<EMPRESA>>", preins_ecp_objeto.getEmpresa()));
                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<CARGO>>", preins_ecp_objeto.getCargo()));

                correoActual.setCuerpo(
                        correoActual.getCuerpo().replaceAll("<<PROBLEMA>>", preins_ecp_objeto.getNombreProblema()));
                correoActual.setCuerpo(
                        correoActual.getCuerpo().replaceAll("<<UBICACION>>", preins_ecp_objeto.getUbicacionProblema()));
                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<DESCRIPCION>>",
                        preins_ecp_objeto.getDescripcionProblema()));
                correoActual.setCuerpo(correoActual.getCuerpo().replaceAll("<<COMUNIDAD_OBJETIVO>>",
                        preins_ecp_objeto.getComunidadObjetivoProblema()));
    ...
    public void guardarPreinscripcionOriginal() {
        ...
        if (guardarPersonaInvestigadorBasico()) {
            ...
            preins_ecp_objeto.setFormacion_academica(formacion_academica_atributo);
            ...
            preins_ecp_objeto.setOtroMedioPublicidad(otroTipoMedioInfo);
            ...
            if (documento != "" && primer_nombre != "" && primer_apellido != "" && segundo_apellido != ""
                    && correo_electronico != "") {
                ...
                if (id_oferta != -1 && curso != null) {
                    ...
                    for (int i = 0; i < listaArchivosNuevos.size(); i++) {
                        ArchivosPreinscripcionECP ar = listaArchivosNuevos.get(i);
                    ...
                    for (int i = 0; i < listaArchivosBorrados.size(); i++) {
                        ArchivosPreinscripcionECP ar = listaArchivosBorrados.get(i);
                        ar.setPreinscripcionECP(preins_ecp_objeto);
                    ...
                    if (ins_act == "I") {
                        FacesContext.getCurrentInstance().addMessage("msgForm", new FacesMessage(
                                FacesMessage.SEVERITY_INFO, "La información ha sido registrada con éxito", ""));
                        habilita_guardar = true;
                    } else
                        FacesContext.getCurrentInstance().addMessage("msgForm", new FacesMessage(
                                FacesMessage.SEVERITY_INFO, "La información ha sido actualizada con éxito", ""));

                    FacesContext.getCurrentInstance().addMessage("growl", new FacesMessage(FacesMessage.SEVERITY_INFO,
                            "", "Se ha enviado un correo electrónico con los datos registrados"));
            ...
            FacesContext.getCurrentInstance().addMessage("growl", new FacesMessage(FacesMessage.SEVERITY_ERROR,
                    "Se ha presentado un error", "Intentelo de nuevo por favor"));
    ...
    public void guardarPreinscripcion() {
        ...
        if (guardarPersonaInvestigadorBasico()) {
            ...
            preins_ecp_objeto.setCargo(cargo);
            preins_ecp_objeto.setEmpresa(empresa);
            preins_ecp_objeto.setEstado(estado);
            preins_ecp_objeto.setFeccre(feccre);
            preins_ecp_objeto.setFormacion_academica(formacion_academica_atributo);
            preins_ecp_objeto.setTipo_empresa(tipo_empresa);
            ...
            preins_ecp_objeto.setMedio_publicidad(medio_publicidad);
            preins_ecp_objeto.setOtroMedioPublicidad(otroTipoMedioInfo);
            preins_ecp_objeto.setNombreProblema(nombreProblema);
            preins_ecp_objeto.setDescripcionProblema(descripcionProblema);
            preins_ecp_objeto.setUbicacionProblema(ubicacionProblema);
            preins_ecp_objeto.setComunidadObjetivoProblema(comunidadObjetivoProblema);

            preins_ecp_objeto.setCiudadProblema(ciudad_atributo_problema);
            preins_ecp_objeto.setDepartamentoProblema(departamento_atributo_problema);
            ...
            if (documento != "" && primer_nombre != "" && primer_apellido != "" && segundo_apellido != ""
                ...
                if (id_oferta != -1 && curso != null) {
                    ...
                    enviarCorreoBancoProblemas();

                    if (ins_act == "I") {
                        FacesContext.getCurrentInstance().addMessage("msgForm",
                                new FacesMessage(FacesMessage.SEVERITY_INFO,
                                        "La informacion ha sido registrada con éxito, el ID del problema resgistrado es: "
                                                + preins_ecp_objeto.getId_pre(),
                                        ""));
                        habilita_guardar = true;
                    } else
                        FacesContext.getCurrentInstance().addMessage("msgForm",
                                new FacesMessage(FacesMessage.SEVERITY_INFO,
                                        "La informacion ha sido actualizada con éxito, el ID del problema resgistrado es: "
                                                + preins_ecp_objeto.getId_pre(),
                                        ""));
        ...
        if (guardarPersonaInvestigadorBasico()) {
            ...
            if (documento != "" && primer_nombre != "" && primer_apellido != "" && segundo_apellido != ""
                ...
                if (id_oferta != -1 && curso != null) {
                    ...
                    if (ins_act == "I") {
                        FacesContext.getCurrentInstance().addMessage("msgForm", new FacesMessage(
                                FacesMessage.SEVERITY_INFO, "La informacion ha sido registrada con éxito", ""));
                        habilita_guardar = true;
                    } else
                        FacesContext.getCurrentInstance().addMessage("msgForm", new FacesMessage(
                                FacesMessage.SEVERITY_INFO, "La informacion ha sido actualizada con éxito", ""));
    ...
    public void subirArchivos(FileUploadEvent event) throws IOException {
        if (event.getFile() != null) {
            ...
            archivo.setNombreArchivo(quitarAcentos(event.getFile().getFileName()));
    ...
    public String volver() {
        sesion.removeAttribute("ManejadorBuscadorCatalogoECP");
        sesion.removeAttribute("ManejadorPreinscripcionECP");
        sesion.removeAttribute("ManejadorPreinscripcionBancoProblemas");
        return "salir";
    }

    public String irBuscadorCursosECP() {
        sesion.removeAttribute("ManejadorPreinscripcionECP");
        return "irBurcadorCursosECP";
    }
    ...
    private void cargarFormacionAcademica() {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            formacionAcademicaItemList.add(new SelectItem(tipoFor.getId(), tipoFor.getNombre()));
        }
    ...
    public void cargarDepto() {
        ...
        String consulta = "select dd from Departamento dd where dd.id not in ('UY01','US01','MX01','00','CL01','AR01','VE01','CR01','ES01','BR01') order by dd.nombre asc";
        List lista = servicioGeneral.obtenerObjetos(consulta);
        for (int i = 0; i < lista.size(); i++) {
            Departamento depto = (Departamento) lista.get(i);
            departamentoItemList.add(new SelectItem(depto.getId(), depto.getNombre()));
        }
        departamento = "CO11";
    }

    public void cargarRolesRegistro() {
        rolRegistroItemList = new ArrayList<SelectItem>();
        List<DominioDetalle> listaRolRegistro = new ArrayList<DominioDetalle>();
        listaRolRegistro = servicioGeneral.obtenerObjetos(
                "select dd from Dominio d, DominioDetalle dd where d.id = dd.identificador.id and d.tipo ='"
                        + "TIPO_PARTICIPANTE_EXT_SOL_2016" + "' order by dd.descripcion");
        for (int i = 0; i < listaRolRegistro.size(); i++) {
            DominioDetalle dd = (DominioDetalle) listaRolRegistro.get(i);
            if (dd.getIdentificador().getTipo().equals("DOC_UN")) {
                if (esDocente) {
                    rolRegistroItemList.add(new SelectItem(dd.getIdentificador().getTipo(), dd.getDescripcion()));
                }
            } else {
                if (dd.getIdentificador().getTipo().equals("EST_UN")) {
                    if (esEstudiante) {
                        rolRegistroItemList.add(new SelectItem(dd.getIdentificador().getTipo(), dd.getDescripcion()));
                    }
                } else {
    ...
    public void cambiarCiudad() {
        ...
        // CIUDADES
        List listaCiudades = servicioGeneral
                .obtenerObjetos("select c from Ciudad c where c.id <> 'CO11' and c.departamento.id = '"
                        + this.departamentoProblema + "'");
    ...
    public void cargarCiudades() {
        ...
        if (this.departamentoProblema == null) {
            depto = "CO11";
        } else
            depto = this.departamentoProblema;

        String consulta = "select cc from Ciudad cc where cc.id <> 'CO11' and cc.departamento = '" + depto + "'";
        List listaCiudades = servicioGeneral.obtenerObjetos(consulta);
    ...
    public void cargarCiudadCompletas()
	{
		...
		ciudadItemListProblema = new ArrayList<SelectItem>();

		String consulta = "select cc from Ciudad cc where cc.id not in ('CO11','CO01999','CO13','CO05896','CO52886','CO02999') and cc.departamento not in ('UY01','US01','MX01','00','CL01','AR01','VE01','CR01','ES01','BR01') order by cc.nombre asc";
		List lista = servicioGeneral.obtenerObjetos(consulta);
		for (int i = 0; i < lista.size(); i++)
		{
			Ciudad ciudad = (Ciudad) lista.get(i);
			ciudadItemList.add(new SelectItem(ciudad.getId(), ciudad.getNombre() + " (" +  ciudad.getDepartamento().getNombre() +  ")"));
			ciudadItemListProblema.add(new SelectItem(ciudad.getId(), ciudad.getNombre() + " (" +  ciudad.getDepartamento().getNombre() +  ")"));
		}
	}
    ...
    public void cargarOtrosIntereses() {
        ...
        for (int i = 0; i < lista.size(); i++) {
            AgendaConocimiento agd_conocimiento = (AgendaConocimiento) lista.get(i);
            otrosInteresesItemList.add(new SelectItem(agd_conocimiento.getId(), agd_conocimiento.getNombre()));
        }
    }
    ...
    public void cargarTipoVinculacion() {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            tipoVinculacionItemList.add(
                    new SelectItem(tipo_vinculacion.getIdentificador().getTipo(), tipo_vinculacion.getDescripcion()));
        }
    }
    ...
    public void cargarEstadoCivilOpciones() {
        List listaEstadoCivil = servicioGeneral.obtenerListaObjetos("EstadoCivil");
        ...
        for (int i = 0; i < listaEstadoCivil.size(); i++) {
            ...
            estadoCivilItemList.add(new SelectItem(estado.getId(), estado.getNombre()));
        }
    }
    ...
    public void cargarSectoresEmpresa() {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            sectorEmpresaItemList.add(new SelectItem(sector.getIdentificador().getTipo(), sector.getDescripcion()));
        }
    }
    ...
    public void cargarTiposEmpresa() {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            tipoEmpresaItemList.add(new SelectItem(tipo.getIdentificador().getTipo(), tipo.getDescripcion()));
        }
    }
    ...
    public void cargarMediosPublicidad() {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            medioPublicidadItemList.add(new SelectItem(medio.getIdentificador().getTipo(), medio.getDescripcion()));
        }
    }
    ...
    public void cargarOcupacionOpciones() {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            ocupacionItemList.add(new SelectItem(ocupacion.getIdentificador().getTipo(), ocupacion.getDescripcion()));
        }
    }
    ...
    public void setFormacionAcademicaItemList(List<SelectItem> formacionAcademicaItemList) {
    ...
    public void setFormacion_academica_atributo(TipoFormacion formacion_academica_atributo) {
    ...
    public void setOtrosInteresesItemList(List<SelectItem> otrosInteresesItemList) {
    ...
    public void setOtros_intereses_atributo(AgendaConocimiento otros_intereses_atributo) {
    ...
    public void setTipoVinculacionItemList(List<SelectItem> tipoVinculacionItemList) {
    ...
    public void setTipo_vinculacion_atributo(DominioDetalle tipo_vinculacion_atributo) {
    ...
    public Investigador getEmpleado() {
        return empleado;
    }

    public void setEmpleado(Investigador empleado) {
    ...
    public void setMedioPublicidadItemList(List<SelectItem> medioPublicidadItemList) {
    ...
    public static void setLogger(Logger logger) {
        ManejadorPreinscripcionBancoProblemas.logger = logger;
    }
    ...
    public void setMedio_publicidad_atributo(DominioDetalle medio_publicidad_atributo) {
    ...
    public void setListaArchivosNuevos(List<ArchivosPreinscripcionECP> listaArchivosNuevos) {
    ...
    public void setListaArchivosBorrados(List<ArchivosPreinscripcionECP> listaArchivosBorrados) {
    ...
    public void cargarListasParticipantes() {
        ...
        orinoquia.put("9528429", "Arauca | Viernes, 06 de septiembre de 2013");
        orinoquia.put("19473899", "Arauca | Viernes, 06 de septiembre de 2013");

        monteria.put("30896970", "Montería | Viernes, 20 de septiembre de 2013");
        monteria.put("78294542", "Montería | Viernes, 20 de septiembre de 2013");
        monteria.put("78298751", "Montería | Viernes, 20 de septiembre de 2013");
        monteria.put("50904762", "Montería | Viernes, 20 de septiembre de 2013");

        medellin.put("70135800", "Medellín | Viernes, 06 de septiembre de 2013");
        medellin.put("98577822", "Medellín | Viernes, 06 de septiembre de 2013");
        medellin.put("21424011", "Medellín | Viernes, 06 de septiembre de 2013");
        medellin.put("52098984", "Medellín | Viernes, 06 de septiembre de 2013");

        manizales.put("24334177", "Manizales | Viernes, 06 de septiembre de 2013");
        manizales.put("10143816", "Manizales | Viernes, 06 de septiembre de 2013");

        ibague.put("93389539", "Ibagué | Viernes, 04 de octubre de 2013");
        ibague.put("65776424", "Ibagué | Viernes, 04 de octubre de 2013");
        ibague.put("1110462217", "Ibagué | Viernes, 04 de octubre de 2013");
        ibague.put("1109294782", "Ibagué | Viernes, 04 de octubre de 2013");

        villavicencio.put("11376059", "Villavicencio | Viernes, 27 de septiembre de 2013");
        villavicencio.put("80047706", "Villavicencio | Viernes, 27 de septiembre de 2013");
        villavicencio.put("17390690", "Villavicencio | Viernes, 27 de septiembre de 2013");
        villavicencio.put("17389661", "Villavicencio | Viernes, 27 de septiembre de 2013");
        villavicencio.put("80175766", "Villavicencio | Viernes, 27 de septiembre de 2013");
        villavicencio.put("86080031", "Villavicencio | Viernes, 27 de septiembre de 2013");
        bucaramanga.put("91286021", "Bucaramanga | Viernes, 20 de septiembre de 2013");
        bucaramanga.put("91218674", "Bucaramanga | Viernes, 20 de septiembre de 2013");
        bucaramanga.put("1098622174", "Bucaramanga | Viernes, 20 de septiembre de 2013");
        bogotaUno.put("9870016", "Bogotá (1) | Viernes, 06 de septiembre de 2013");
        bogotaUno.put("79410911", "Bogotá (1) | Viernes, 06 de septiembre de 2013");
        bogotaUno.put("11809178", "Bogotá (1) | Viernes, 06 de septiembre de 2013");
        bogotaUno.put("19404247", "Bogotá (1) | Viernes, 06 de septiembre de 2013");
        bogotaUno.put("79684468", "Bogotá (1) | Viernes, 06 de septiembre de 2013");
        bogotaUno.put("1053802877", "Bogotá (1) | Viernes, 06 de septiembre de 2013");
        bogotaDos.put("52337478", "Bogotá (2) | Viernes, 13 de septiembre de 2013");
        bogotaDos.put("41753294", "Bogotá (2) | Viernes, 13 de septiembre de 2013");
        bogotaDos.put("14224506", "Bogotá (2) | Viernes, 13 de septiembre de 2013");
        bogotaDos.put("1053786454", "Bogotá (2) | Viernes, 13 de septiembre de 2013");
        bogotaDos.put("1072639383", "Bogotá (2) | Viernes, 13 de septiembre de 2013");
        bogotaDos.put("52428273", "Bogotá (2) | Viernes, 13 de septiembre de 2013");
        sanAndres.put("52422768", "San Andrés | Viernes, 06 de septiembre de 2013");
        sanAndres.put("72288888", "San Andrés | Viernes, 06 de septiembre de 2013");
        sanAndres.put("39154891", "San Andrés | Viernes, 06 de septiembre de 2013");
        sanAndres.put("18012005", "San Andrés | Viernes, 06 de septiembre de 2013");
    ...
    public String getDepartamentoProblema() {
        return departamentoProblema;
    }

    public void setDepartamentoProblema(String departamentoProblema) {
        this.departamentoProblema = departamentoProblema;
    }

    public String getCiudadProblema() {
        return ciudadProblema;
    }

    public void setCiudadProblema(String ciudadProblema) {
        this.ciudadProblema = ciudadProblema;
    }

    public List<SelectItem> getCiudadItemListProblema() {
        return ciudadItemListProblema;
    }

    public void setCiudadItemListProblema(List<SelectItem> ciudadItemListProblema) {
        this.ciudadItemListProblema = ciudadItemListProblema;
    }

    public Departamento getDepartamento_atributo_problema() {
        return departamento_atributo_problema;
    }

    public void setDepartamento_atributo_problema(Departamento departamento_atributo_problema) {
        this.departamento_atributo_problema = departamento_atributo_problema;
    }

    public Ciudad getCiudad_atributo_problema() {
        return ciudad_atributo_problema;
    }

    public void setCiudad_atributo_problema(Ciudad ciudad_atributo_problema) {
        this.ciudad_atributo_problema = ciudad_atributo_problema;
    }
    ...
    public List<SelectItem> getRolRegistroItemList() {
        return rolRegistroItemList;
    }

    public void setRolRegistroItemList(List<SelectItem> rolRegistroItemList) {
        this.rolRegistroItemList = rolRegistroItemList;
    }

    public List<SelectItem> getTemaProblemaItemList() {
        return temaProblemaItemList;
    }

    public void setTemaProblemaItemList(List<SelectItem> temaProblemaItemList) {
        this.temaProblemaItemList = temaProblemaItemList;
    }

    public List<SelectItem> getSubTemaProblemaItemList() {
        return subTemaProblemaItemList;
    }

    public void setSubTemaProblemaItemList(List<SelectItem> subTemaProblemaItemList) {
        this.subTemaProblemaItemList = subTemaProblemaItemList;
    }

    public String getModalidadRegistro() {
        return modalidadRegistro;
    }

    public void setModalidadRegistro(String modalidadRegistro) {
        this.modalidadRegistro = modalidadRegistro;
    }

	public String getOtroTipoMedioInfo() {
		return otroTipoMedioInfo;
	}

	public void setOtroTipoMedioInfo(String otroTipoMedioInfo) {
		this.otroTipoMedioInfo = otroTipoMedioInfo;
	}
