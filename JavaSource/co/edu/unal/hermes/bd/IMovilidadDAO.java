 ...
 *        grupos
 */
public interface IMovilidadDAO {
     ...
     *             the data access exception
     */
    public List obtenerMovilidadesXTipoConvFacultad(String tipoObjeto, Persona persona, Dependencia dependencia)
            throws DataAccessException;
     ...
     */
    public List obtenerMovilidadesArtes(String tipo, Persona persona, Dependencia dependencia, String idModalidad)
            throws DataAccessException;
