...
public class TipoEdicionPropiedadIntelectual implements java.io.Serializable {
	...
	/** default constructor */
	public TipoEdicionPropiedadIntelectual() {
		
	}
	
	public TipoEdicionPropiedadIntelectual(Long id) {
		this.setId(id);
	}
