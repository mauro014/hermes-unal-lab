...
<html>
  <head>
    <title>B-FT-06.003.008 SESIONES</title>
  </head>
  ...
  <% try{ 
    ...
    File reportFile = new File(application.getRealPath("reportes/reportesECP/sesiones/B-FT-06.003.008_sesiones_curso.jasper") );
    Map parameters = new HashMap();
    parameters.put("ID_CURSO",ID_CURSO);
    parameters.put("SUBREPORT_DIR",application.getRealPath("reportes/reportesECP/sesiones/")+"/");	
